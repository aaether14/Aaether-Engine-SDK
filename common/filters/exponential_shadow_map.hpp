...
public:
    ...
    Calls Init()
    */
    inline ESMImplementation(GLuint width, GLuint height)
    {
    ...
    */
    inline void Use()
    {
        this->shadow_shader->Enable();
    }
    /**
    Get primary shadow map
    */
    inline TextureObject * GetShadowMap()
    {
        return this->shadow_map;
    }
    /**
    Get secondary shadow map
    */
    inline TextureObject * GetTempShadowMap()
    {
        return this->temp_shadow_map;
    }
    ...
    Query shadow pass
    */
    inline GLboolean OnShadowPass()
    {
        return this->on_shadow_pass;
    }
    /**
    Set if on shadow pass
    */
    inline void SetShadowPass(GLboolean on_shadow_pass)
    {
        this->on_shadow_pass = on_shadow_pass;
    }

    /**
    Provide ModelViewProjection to the shader that computes shadow map
    */
    inline void UniformMVP(glm::mat4 MVP)
    {
        this->shadow_shader->Set("depthMVP", MVP);
    }
