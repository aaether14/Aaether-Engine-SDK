...
public:
    ...
    Calls Init()
    */
    inline HdrImplementation(GLuint width, GLuint height)
    {
    ...
    */
    inline TextureObject * GetBrightTexture()
    {
    ...
    */
    inline TextureObject * GetBrightTextureTemp()
    {
        return this->bright_texture_temp;
    }
    ...
    */
    inline Shader * GetBrightShader()
    {
        return this->bright_shader;
    }
    /**
    Bind texture unit for bloom shader
    */
    inline void BindBrightTexture()
    {
        this->bright_shader->Set("texture", 0);
    }
