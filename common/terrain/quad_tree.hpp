...
public:
	...
	*/
	...
	Get index of node
	*/
	inline GLuint GetInd(){ return ind; }
	...
	*/
	...
	Get child nodes
	*/
	inline std::vector<boost::shared_ptr<QuadNode> > GetNodes(){ return nodes; }
	/**
	Pointer to node's TerrainStrip (if terminal node, otherwise NULL)
	*/
	inline TerrainStrip *GetChunk(){return chunk.get();}
...
public:
	...
	*/
	inline QuadNode* GetStartNode() { return start_node.get(); }
	...
	*/
	inline QuadTree(){ start_node.reset(new QuadNode); }
