...
public:
    ...
    */
    inline AEntityInstance* GetChildNode(GLuint i)
    {
    ...
    */
    inline GLuint GetNumberOfChilds()
    {
    ...
    Add child node
    */
    inline void AddChildNode(AEntityInstance* new_child)
    {
        child_nodes.push_back(boost::shared_ptr<AEntityInstance>(new_child));
    }
    /**
    ...
    */
    inline AEntityInstanceInfo * GetInformation(std::string name)
    {
    ...
    */
    ...
    Set entity name
    */
    inline void SetEntityName(std::string name)
    {
        entity_name = name;
    }
