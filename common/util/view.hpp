...
public:
    ...
    */
    ...
    inline void setUpVec(glm::vec3 t_vec)
    {
        this->up = t_vec;
    }
    ...
    inline GLfloat getRatio()
    {
        return this->ratio;
    }
    inline void setRatio(GLfloat ratio)
    {
        this->ratio = ratio;
    }
    ...
    inline void SetRenderDistance(GLfloat r_d)
    {
        this->render_distance = r_d;
    }
    inline void SetCameraPos(glm::vec3 pos)
    {
        this->position = pos;
    }
    inline void SetCameraY(GLfloat y)
    {
        this->position.y = y;
    }
    inline void SetDistance(GLfloat new_distance)
    {
    ...
    inline GLfloat getTanHalfFov()
    {
        return tanf((FoV / 2.0f) * M_PI / 180.0);
    }
    inline void setFov(GLfloat FoV)
    {
        this->FoV = FoV;
    }
    inline GLfloat getRenderDistance()
    {
        return this->render_distance;
    }
    inline GLfloat getDistance()
    {
...
public:
    ...
    */
    ...
    Set projection
    */
    inline void SetProjection(glm::mat4 ProjectionMatrix)
    {
    ...
    Set view matrix
    */
    inline void SetView(glm::mat4 ViewMatrix)
    {
