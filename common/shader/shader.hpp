...
public:
    ...
    */
    inline void AddVariable(char * name)
    {
        this->uniforms[name] = glGetUniformLocation(this->program, name);
    }
    /**
    Set an integer to uniform unit
    */
    inline void Set(char * name, GLint v)
    {
        glUniform1i(this->uniforms[name], v);
    }
    /**
    Set a float to uniform unit
    */
    inline void Set(char * name, GLfloat v)
    {
        glUniform1f(this->uniforms[name], v);
    }
    /**
    Set a double to uniform unit
    */
    inline void Set(char * name, GLdouble v)
    {
        glUniform1d(this->uniforms[name], v);
    }
    /**
    Set a 3D vector to uniform unit
    */
    inline void Set(char * name, glm::vec3 v)
    {
    ...
    Set a 3D vector to uniform unit
    */
    inline void Set(char * name, GLfloat x, GLfloat y, GLfloat z)
    {
    ...
    */
    inline void Set(char * name, glm::vec3 * v, GLuint n)
    {
        glUniform3fv(this->uniforms[name], n, (const GLfloat*)&v[0]);
    }
    /**
    Set a 4D vector to uniform unit
    */
    inline void Set(char * name, glm::vec4 v)
    {
    ...
    Set a 4D vector to uniform unit
    */
    inline void Set(char * name, GLfloat x, GLfloat y, GLfloat z, GLfloat w)
    {
    ...
    */
    inline void Set(char * name, glm::mat4 v)
    {
        glUniformMatrix4fv(this->uniforms[name], 1, GL_FALSE, &v[0][0]);
    }
