...
public:
    ...
    */
    inline View * GetView()
    {
        return this->view_3rd;
    };
    /**
    Get pointer to ViewInfo
    */
    inline ViewInfo *GetInfo()
    {
        return this->info;
    }
    /**
    ...
    */
    inline void SetBaseSpeed(GLfloat base_speed)
    {
    ...
    */
    inline void SetFrustum(glm::mat4 MV)
    {
        this->frustum->Create(MV);
    }
    ...
    */
    inline void setHorizontalAngle(GLfloat angle)
    {
    ...
    */
    inline void setVerticalAngle(GLfloat angle)
    {
    ...
    */
    inline GLdouble getHorizontalAngle()
    {
    ...
    */
    inline GLdouble getVerticalAngle()
    {
